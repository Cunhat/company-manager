...
export function InvoiceForm({
  ...
  const validationSchema: z.ZodType<InvoiceFormValues, InvoiceFormValues> =
    mode === "create" ? createInvoiceSchema : editInvoiceFormSchema;
  const form = useForm({
    defaultValues,
        ...
        {(isSubmitting) => (
          ...
          >
            ...
            <p className="text-xs text-muted-foreground">
              Paid invoices add the entered amount plus IVA to this account. Pending and cancelled
              invoices do not affect its balance.
            </p>
